...
const route_variation : route_obj[] = [
  ...
  const RouteName_EN : {[name_ja:string]:string} = {}
  RouteName_EN["中央"] = "Central"
  RouteName_EN["西部"] = "Western"
  RouteName_EN["北部"] = "North"
  RouteName_EN["南部"] = "South"
    ...
    <Carousel>
      <Carousel.Item>
        <img
          ...
          src="https://www.city.nonoichi.lg.jp/uploaded/image/s/20151.png"
          alt="First slide"
           width="50" height="350"
        />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://www.city.nonoichi.lg.jp/uploaded/image/s/20169.png"
          alt="Second slide"
           width="50" height="350"
        />
        ...
        <img
          className="d-block w-100"
          src="https://www.city.nonoichi.lg.jp/uploaded/image/s/20176.png"
          alt="Third slide"
           width="50" height="350"
        />
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://www.city.nonoichi.lg.jp/uploaded/image/s/20174.png"
          alt="Third slide"
           width="50" height="350"
        />
